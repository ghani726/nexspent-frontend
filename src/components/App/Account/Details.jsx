...
const Details = () => {
	...
	return (
		<>
			<div className="flex animate-fade-in flex-col justify-center items-center w-full bg-white p-4 rounded-4xl">
			...
			<div className="flex flex-col justify-center items-center w-full bg-white p-4 rounded-4xl gap-4">
