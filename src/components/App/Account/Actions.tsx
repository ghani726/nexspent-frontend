...
const Actions = ({ setSlider }: { setSlider: (value: number) => void }) => {
    const { user } = useAuth();
    ...
    if (errors.fullName) {
        ...
        toast.dismiss();
        toast.error(errors.userName.message as string);
        ...
        toast.dismiss();
        toast.error(errors.newPasswordConfirm.message as string);
    }

    return (
        <>
            <div className="flex flex-col animate-fade-in justify-center items-center w-full bg-white shadow-medium dark:bg-gray-800 rounded-5xl">
                <form
            ...
            <div className="flex flex-col animate-fade-in justify-center items-center w-full bg-white shadow-medium dark:bg-gray-800 rounded-5xl p-6 gap-2">
                <h2 className="text-2xl font-bold text-primary w-full text-start mb-2">
