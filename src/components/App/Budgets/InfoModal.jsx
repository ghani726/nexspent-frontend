	...
	return (
		...
		>
			...
			<span className="flex bg-primary p-4 rounded-full text-white justify-center items-center">
				<PieChart size={36}></PieChart>
			</span>
			<h2 className="text-primary text-3xl font-bold">Budgets</h2>
			<p className="text-center text-lg max-w-100">
				A budget sets a planned limit for spending or saving within a
				period. Budgets break down finances by timeframe, provide
				insights, and help you track and control your money.
			</p>
