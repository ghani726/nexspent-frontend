...
import type { IDeleteHandlerProps } from "@/types/common";
        ...
        >
            ...
            <div className="flex justify-between items-center gap-2">
                <button
                    ...
                    disabled={isLoading}
                    className="px-5 text-sm disabled:cursor-not-allowed cursor-pointer active:scale-95 py-3 leading-4.5 rounded-3xl bg-app dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-800 hover:scale-103 disabled:active:scale-100  duration-300 ease-in-out"
                >
                    Keep {UpperCaseText}
                </button>
                <button
                    ...
                    className="px-5 text-sm disabled:bg-red-400 disabled:active:scale-100 disabled:cursor-not-allowed cursor-pointer active:scale-95 py-3 leading-4.5 rounded-3xl bg-red-600 dark:bg-red-700 hover:scale-103 text-white font-semibold hover:bg-red-700 duration-300 ease-in-out flex gap-2"
                >
                    {isLoading && (
