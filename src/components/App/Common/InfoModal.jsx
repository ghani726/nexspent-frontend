...
const InfoModal = ({ ref, closeInfoModal, title, desc, icon }) => {
    ...
    return (
        <dialog
            ...
            className={`flex open:flex duration-300 ease-in-out gap-2 flex-col justify-center shadow-large min-w-2xs w-9/10 ms:w-2/3 md:w-1/2 lg:w-1/3 items-center p-10 rounded-5xl bg-surface dark:bg-gray-950 dark:text-white fixed top-1/2 left-1/2 -translate-1/2`}
        >
            <button
                title="Close"
