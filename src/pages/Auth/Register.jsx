...
const RegisterPage = () => {
  ...
  return (
    <div className="flex overflow-auto justify-center items-center w-full min-h-dvh py-8">
      <div className="bg-white max-h-9/10 animate-fade-in shadow-[0_0_24px_rgba(0,0,0,0.1)] transition-all duration-500 ease-in-out h-auto min-w-80 w-auto ms:min-w-md lg:w p-6 md:p-8 rounded-5xl flex flex-col justify-center items-center gap-6">
        ...
        >
            ...
            <div className="input-box text-lg bg-gray-100 rounded-5xl px-4">
              <input
                ...
                {...register("fullName", {
                  ...
                  minLength: {
                    value: 4,
                    message: "Full name must be 4 to 30 characters.",
                  },
                  maxLength: {
                    value: 30,
                    message: "Full name must be 4 to 30 characters.",
            ...
            <div className="input-box-p text-lg bg-gray-100 rounded-5xl px-4">
              <input
                ...
                {...register("password", {
                  ...
                  minLength: {
                    value: 8,
                    message: "Password must be 8 to 32 characters.",
                  },
                  maxLength: {
                    value: 32,
                    message: "Password must be 8 to 32 characters.",
          ...
          <button
            ...
            className="p-3 text-center bg-primary disabled:bg-primary/70 cursor-pointer disabled:active:scale-100 disabled:cursor-not-allowed rounded-5xl active:scale-95  transition-all ease-in-out duration-300 text-white font-semibold"
          >
            Create Account
          </button>
        </form>
