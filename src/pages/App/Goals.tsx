        ...
        <div className="relative w-full lg:max-w-7/10 flex flex-col gap-4">
            <div className="flex justify-between items-center">
                ...
                <InfoModal
                    ...
                    title={"Goals"}
                    desc={
                        "A goal is a specific target you want to achieve within a certain timeframe. Goals help you focus your efforts and measure your progress."
                    }
            ...
            {showModal && (
                ...
                //     handleButtonClick={() => console.log("Lick")}
                //     text="Goal"
                // ></BaseModal>
            )}
        </div>
